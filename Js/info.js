    ...
    createBanner: function () {
      postersInfo = {
        superman: {
          ...
          released_year: "1983",
          description:
            "batman is an ongoing American comic book series featuring the DC Comics superhero batman as its main protagonist. Superman began as one of several anthology features in the National Periodical Publications comic book Action Comics in June 1938. The strip proved so popular that National launched Superman into his own self-titled comic book, the first for any superhero, premiering with the cover date Summer 1939.",
        },
        spiderman: {
          banner_url: "./assets/dr strange.jpg",
          title: "Spiderman",
          released_year: "1962",
          description:
        ...
        "captain-aero": {
          banner_url: "./assets/iron man.webp",
          title: "Captain Aero",
          released_year: "1942",
          description:
